...
- [STEP6-6 / STEP6-7 月次運用レポート・改善サイクル](docs/STEP6_MONTHLY_CYCLE.md)

JSTの暦月単位で匿名運用データを集計し、改善候補を未対応・対応中・完了・見送りで追跡できます。


## 自動運用

- [STEP6-8 / STEP6-9 月次自動保存・自動通知](docs/STEP6_AUTOMATION.md)

既存の日次GASトリガーを使い、前月レポートのDrive保存、異常・改善候補の状態変化通知、自動運用結果の記録を行います。
